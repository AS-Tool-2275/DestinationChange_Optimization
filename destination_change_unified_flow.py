...
def build_vendor_offset_maps(
    ...
    - If multiple files are uploaded, file order follows the detected Timeline vendor order.
    ...
    if timeline_vendor_df is None or timeline_vendor_df.empty:
        return vendor_maps, pd.DataFrame([
            ["Vendor DueDate mapping", "No vendor detected from PlanDetailTimeline; default DueDateCalc will be used"]
        ], columns=["Field", "Value"])
