...
- `Optimized Data` is the main result sheet.
- The backend also keeps the zero-SS fallback equalization pass for items where `Average of SS Wk3 = 0`.
- Optional OSQP second-pass sheets can be added if enabled.
"""
        )
