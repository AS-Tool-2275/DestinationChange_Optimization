...
- **Priority SI = 0** is treated as a hard lock: keep the warehouse F quantity unchanged.
- **Zero-SS fallback** equalizes SI After across warehouses where Average of SS Wk3 = 0.
